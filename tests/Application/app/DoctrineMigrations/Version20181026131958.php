 ...
 */
final class Version20181026131958 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE sylius_supplier_plugin_supplier (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, enabled BOOLEAN NOT NULL)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE app_supplier (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, description VARCHAR(255) NOT NULL COLLATE BINARY, enabled BOOLEAN NOT NULL)');
        $this->addSql('DROP TABLE sylius_supplier_plugin_supplier');
        $this->addSql('DROP INDEX IDX_B97FF0589395C3F3');
        $this->addSql('CREATE TEMPORARY TABLE __temp__sylius_address AS SELECT id, customer_id, first_name, last_name, phone_number, street, company, city, postcode, created_at, updated_at, country_code, province_code, province_name FROM sylius_address');
        $this->addSql('DROP TABLE sylius_address');
